...
console = logger;
console.log(chalk.gray("[📝]") + chalk.cyan("[") + chalk.white("Nimbexa") + chalk.cyan("]") + chalk.white(" Any log from now on will be duly noted in both the console and the log file! "));
