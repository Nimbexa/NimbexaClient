...
module.exports.load = async function (app, db) {
  ...
  app.get(`/earn/gyani/redeem/:code`, async (req, res) => {
    ...
    const usercode = glcodes[req.session.userinfo.email];
    ...
    await db.set(`coins-${req.session.userinfo.email}`, coins + settings.gyanilinks.coins)    
